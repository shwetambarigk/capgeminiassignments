...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total Marks for Subject B : "+ Total_B + " and Averge Marks : " + Total_B/3);
        System.out.println("Total Marks for Subject C : "+ Total_C + " and Averge Marks : " + Total_C/3);
    }
}
